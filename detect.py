...
while capture.isOpened():
	...
	# TODO detect a hand gesture and return the right action / name.
		...
		for i in gesture:
			...
			gest_percent.append([ i["name"], i["who"], matching/21*100])


		if gest_percent:
			best_gesture = sorted(gest_percent, key = lambda x: x[2], reverse=True)[0]

			if best_gesture[2] > 85:
