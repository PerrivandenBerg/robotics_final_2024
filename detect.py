...
gesture.append({"who": "perri", "cmd": "exit"		, "name": "flip_off"	, "min":  [np.array([0.59754, 0.00000, 0.74836]), np.array([1.00000, 0.00000, 0.00000]), np.array([0.00000, 0.00000, 1.00000]), np.array([0.55328, 0.00000, 0.64182]), np.array([0.89336, 0.00000, 0.17614]), np.array([0.28361, 0.00000, 0.00000]), np.array([1.00000, 0.00000, 0.00000]), np.array([1.00000, 0.00000, 0.00000]), np.array([0.00000, 0.00000, 0.00000]), np.array([0.00000, 0.00000, 0.00000]), np.array([1.00000, 0.00000, 0.36986]), np.array([0.72015, 0.12819, 0.00000]), np.array([0.92632, 0.00000, 0.46067]), np.array([0.89969, 0.00000, 0.49412]), np.array([0.73076, 0.00000, 0.00000]), np.array([0.49816, 0.19802, 0.00000]), np.array([0.00000, 0.73605, 0.23584]), np.array([0.00000, 1.00000, 0.36336]), np.array([0.00000, 0.00000, 0.00000]), np.array([0.00000, 0.74072, 0.46851]), np.array([0.00000, 0.78028, 0.41449])] , "max":  [np.array([1.00000, 0.00000, 1.00000]), np.array([1.00000, 0.29227, 0.59166]), np.array([0.85353, 0.40643, 1.00000]), np.array([1.00000, 0.00000, 1.00000]), np.array([1.00000, 0.00000, 1.00000]), np.array([1.00000, 0.32085, 1.00000]), np.array([1.00000, 0.00289, 0.79538]), np.array([1.00000, 0.98145, 0.09064]), np.array([1.00000, 1.00000, 0.57610]), np.array([1.00000, 1.00000, 0.62859]), np.array([1.00000, 0.00000, 0.95414]), np.array([1.00000, 1.00000, 0.00000]), np.array([1.00000, 0.00000, 1.00000]), np.array([1.00000, 0.00000, 1.00000]), np.array([1.00000, 0.52003, 1.00000]), np.array([1.00000, 1.00000, 0.00000]), np.array([0.00000, 1.00000, 1.00000]), np.array([0.00000, 1.00000, 0.88273]), np.array([1.00000, 1.00000, 1.00000]), np.array([0.00000, 1.00000, 1.00000]), np.array([0.00000, 1.00000, 1.00000])] })
...
while capture.isOpened():
	...
	elif new_command == "thumbs_up" or new_command == "thumbs_down":
		sock.send_command(new_command)
		curr_command = new_command
